...
import dd1 from "../media/d_double_single/디럭스 누마루 2 PC_20171120185606 (1).jpg";
import dd2 from "../media/d_double_single/디럭스 누마루 3 PC_20171219170527.jpg";
import dd3 from "../media/d_double_single/디럭스 누마루 4 PC_20171219170533.jpg";
import dd4 from "../media/d_double_single/디럭스누마루_1216x608_20170817170746.jpg";
    ...
    return (
        <div>
            ...
            <div className="container rooms">
                <h2>Introduction</h2>
                <p>넓은 공간감을 느껴지는 디럭스 누마루는 더블 & 싱글 베드와 사무공간이 마련되어 있어 비즈니스 고객부터 세 명의 가족단위 고객까지 여유롭고 편안하게 이용할 수 있는 객실입니다.</p>
